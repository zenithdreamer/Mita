...
// ☆☆☆☆☆☆☆☆☆
// this is the example HAL for ESP32 from RadioLib repo so we can use radioLib in nonarduino
// for more info see https://github.com/jgromes/RadioLib/tree/master/examples/NonArduino/ESP-IDF
// ☆☆☆☆☆☆☆☆☆
