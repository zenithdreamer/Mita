#ifndef MITA_ROUTER_PIHAL_HPP
#define MITA_ROUTER_PIHAL_HPP
// include RadioLib (path resolved by CMake include directories)
#include "RadioLib.h"
...
// **********************************************************************
// this is also a file from example in RadioLib repository
// so its can run on pi
// **********************************************************************
